...
################################################################################
####                                                                       #####
####  Chroot - Facilitate the chroot from a livecd/usb                     #####
...
####  chroot file(s), you may extend this exception to your version        #####
...
cryptsetup --key-file $MNT/.key_files/thinkpad-w541/root.txt luksOpen $ROOT rootfs
printf "Please wait, decrypting home-opt-swap\n"
cryptsetup --key-file $MNT/.key_files/thinkpad-w541/root.txt luksOpen $HOME home
