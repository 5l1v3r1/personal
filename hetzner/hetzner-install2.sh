...
CRYPTKEY="nr1|Q'aSFASFy_2X%OkYiEwis--__\m/o_O\m/--/HAHAHAhohoho\T-#wii9w8@\mo-Om\WUs3MANwusemanIlOVeYouu1GC=f,ve4lj:t]c^____---\\\__-.-__\\\...QPiNg=iH*5\m/2idwsIjw("
...
# ADD KEY
# echo $CRYPTKEY|cryptsetup luksAddKey /dev/sda3 /root/.key_files/hetzner/hetzner-rootfs.txt  -d-
